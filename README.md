...
| Ignore messages before plugin startup          | If true only messages posted after the plugin startup time will be notified. If false, on the first run the plugin will process all messages from the last notified timestamp (stored in the database)                                                                                                                                                                                                                  | NotifyOnlyNewMessagesFromStartup       | false                                                                                                                                                                        |
